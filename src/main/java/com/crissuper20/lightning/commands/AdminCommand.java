 ...
 *   /lnadmin reconnect - Force WebSocket reconnection
 */
public class AdminCommand implements CommandExecutor, TabCompleter {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("§e/lnadmin reconnect §7- Force WebSocket reconnection");
    ...
    private boolean handleStats(CommandSender sender) {
        ...
        if (monitor != null) {
            ...
            sender.sendMessage("§e  Status: §f" + (monitor != null ? "§aRunning" : "§cOffline"));
        }
    ...
    private boolean handleWallets(CommandSender sender) {
        ...
        sender.sendMessage("");
        sender.sendMessage("§eTop Players by Volume (online players only; Fetching Balances...)");
        ...
        for (Map.Entry<UUID, PluginMetrics.PlayerActivity> entry : topPlayers) {
            ...
            // only query balances for online players to avoid passing null Player
            if (player == null) {
                continue;
            }
        ...
        if (balanceFutures.isEmpty()) {
            sender.sendMessage("");
            sender.sendMessage("§7No online top players to fetch balances for.");
            sender.sendMessage("§7Use §e/lnadmin sync [player] §7to sync specific players.");
            return true;
        }
    ...
    private boolean handleWebSocket(CommandSender sender) {
        ...
        sender.sendMessage("");
        sender.sendMessage("§eConnection: §aActive");
        sender.sendMessage("§eWatched wallets: §f" + monitor.getActiveSessionCount());
        sender.sendMessage("");
    ...
    private boolean handleReconnect(CommandSender sender) {
        ...
        sender.sendMessage("§eForcing WebSocket reconnection...");
        
        try {
            monitor.forceReconnectNow();
            sender.sendMessage("§aReconnection initiated!");
            sender.sendMessage("§7Check status with §e/lnadmin websocket");
        } catch (Exception e) {
            sender.sendMessage("§cFailed to reconnect: " + e.getMessage());
    ...
    private boolean handleReload(CommandSender sender) {
        ...
        try {
            ...
            sender.sendMessage("§7WebSocket reconnecting with new settings...");
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        if (args.length == 1) {
            return Arrays.asList("stats", "wallets", "sync", "health",
                    "websocket", "reconnect", "metrics", "reload");
        }
